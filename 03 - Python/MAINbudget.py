...
with open(output_path, 'w', newline='') as csvfile:
    ...
    csvwriter.writerow(['📆Total Months:']:[bank_rows])
#csvwriter.writerow(['📆Total Months: ':bank_rows,'💰TOTAL: $', '💸 AVERAGE CHANGE: ', '🔺GREATEST INCREASE IN PROFITS: ', '🔻GREATEST DECREASE IN PROFITS: ']:[bank_rows,currency_profloss,currency_changes,(maxmonth + currency_changemax), (minmonth, currency_changemin )])
